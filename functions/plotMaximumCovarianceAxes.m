% plotMaximumCovarianceAxes.m — Compare maximum covariance principal axes.
% Shows three-sigma position and velocity axes and deterministic-method differences from MC.
